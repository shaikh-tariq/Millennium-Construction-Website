      ...
      <section className="py-24 bg-[#050505]">
        <div className="max-w-7xl mx-auto px-6">
          <div className="max-w-3xl mb-20">
            <span className="text-[#1565C0] font-bold uppercase tracking-[0.3em] text-xs mb-4 block">Join Our Team</span>
            ...
            <p className="text-xl text-white/60 font-light leading-relaxed">
              At Millennium Construction, we don't just build structures; we build careers. 
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 mb-32">
            {values.map((value, i) => (
              <div key={i} className="glass p-8 border border-white/5">
                <value.icon className="w-10 h-10 text-[#1565C0] mb-6" />
