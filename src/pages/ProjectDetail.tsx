  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-6">
        <Link to="/projects" className="inline-flex items-center gap-2 text-white/40 hover:text-primary transition-colors mb-12 uppercase text-xs font-bold tracking-widest focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#1565C0] rounded-sm p-1">
        ...
        <div className="py-24 border-t border-white/10">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              <Link key={i} to={`/projects/${p.title.toLowerCase().replace(/\s+/g, '-')}`} className="group relative aspect-video overflow-hidden border border-white/5 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#1565C0] rounded-sm block" aria-label={`View details for ${p.title}`}>
