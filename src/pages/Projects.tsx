        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="flex flex-col md:flex-row justify-between items-end mb-20 gap-8">
            <div className="max-w-2xl">
              <span className="text-[#1565C0] font-bold uppercase tracking-[0.3em] text-xs mb-4 block">Our Portfolio</span>
            ...
            <div className="flex flex-wrap gap-4">
              {['All', 'Commercial', 'Industrial', 'Infrastructure'].map((cat) => (
                <button
                  ...
                  className={`px-6 py-2 text-[10px] font-bold uppercase tracking-widest border transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#1565C0] ${filter === cat ? 'bg-[#1565C0] border-[#1565C0] text-black' : 'border-white/10 text-white/40 hover:border-white/30'}`}
                >
                  {cat}
                </button>
              ))}
              ...
              {filteredProjects.map((project, i) => (
                ...
                >
                  <Link
                    ...
                    className="block absolute inset-0 focus-visible:outline-none focus-visible:ring-4 focus-visible:ring-[#1565C0] focus-visible:ring-inset z-10"
                  ...
                  >
                    ...
                    <div className="absolute inset-0 p-10 flex flex-col justify-end pointer-events-none">
                      <span className="text-[10px] font-bold uppercase tracking-widest text-[#1565C0] mb-2">{project.category}</span>
                      ...
                      <span className="flex items-center gap-3 text-[10px] font-bold uppercase tracking-[0.2em] group-hover:text-[#1565C0] transition-colors">
