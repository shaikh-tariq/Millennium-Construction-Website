  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-6">
        <Link to="/" className="inline-flex items-center gap-2 text-white/40 hover:text-primary transition-colors mb-12 uppercase text-xs font-bold tracking-widest focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#1565C0] rounded-sm p-1">
          ...
          <div className="grid md:grid-cols-2 gap-20 items-center">
            <div className="glass p-12 border border-white/5 relative">
              ...
              <p className="text-2xl font-light leading-relaxed mb-8 italic text-white/80 relative z-10">
                "Millennium Construction's ability to navigate the complex structural requirements of the Horizon Tower was unparalleled. They didn't just meet our expectations; they redefined what we thought was possible in urban construction."
              </p>
