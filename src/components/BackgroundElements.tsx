...
const BackgroundElements = () => {
  ...
  return (
    <div className="fixed inset-0 z-[-1] pointer-events-none overflow-hidden">
      {/* Scroll Progress Bar */}
      <motion.div 
        className="fixed top-0 left-0 right-0 h-1 bg-[#1565C0] origin-left z-[100]"
        style={{ scaleX }}
      />
      ...
      <motion.div 
        ...
        className="absolute top-1/4 -left-20 w-96 h-96 bg-[#1565C0] rounded-full blur-[150px] opacity-[0.05]"
      />
      <motion.div 
        animate={{
          x: -mousePos.x * 150,
        ...
        className="absolute bottom-1/4 -right-20 w-[500px] h-[500px] bg-[#1565C0] rounded-full blur-[200px] opacity-[0.03]"
      />
      ...
      >
        <div className="absolute top-1/2 left-0 w-full h-[1px] bg-[#1565C0]/10" />
        <div className="absolute top-0 left-1/2 w-[1px] h-full bg-[#1565C0]/10" />
